...
def validate_models(
    ...
    if load_results and results_file.exists():
        ...
        for dataset, ver, size, soft_nms_flag in combos:
...
if __name__ == "__main__":
    ...
    validate_models(MODELS_ROOT, DATASETS_ROOT, ROOT, load_results=True)
